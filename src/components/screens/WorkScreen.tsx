  ...
  return (
    <Screen id="work">
      <motion.div variants={container} initial="hidden" animate="show">
        ...
        <motion.div variants={item} className="flex gap-3 overflow-x-auto no-scrollbar -mx-6 px-6 pb-3" style={{ scrollSnapType: 'x mandatory' }}>
          {projects.map((project) => (
            <motion.button
              ...
              style={{ background: project.gradient, scrollSnapAlign: 'start' }}
            >
